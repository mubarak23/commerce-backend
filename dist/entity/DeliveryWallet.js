...
let DeliveryWallet = class DeliveryWallet extends BaseEntity_1.default {
    initialize(userId, accountId, walletBalanceMinor) {
...
__decorate([
    ...
    __metadata("design:type", String)
], DeliveryWallet.prototype, "type", void 0);
DeliveryWallet = __decorate([
    (0, typeorm_1.Entity)({ name: Tables_1.default.DELIVERY_FEE_WALLETS }),
    (0, typeorm_1.Index)(["id"], { unique: true }),
    (0, typeorm_1.Index)(["userId"])
], DeliveryWallet);
exports.DeliveryWallet = DeliveryWallet;
//# sourceMappingURL=DeliveryWallet.js.map