...
class ClosePaidOrderCron extends BaseCron_1.default {
    startWorking() {
        return __awaiter(this, void 0, void 0, function* () {
            const connection = yield (0, db_1.getFreshConnection)();
            const threeDayAgoMoment = moment_1.default.utc().add(-48, 'days');
            ...
            const paidOrdersToClose = yield orderRepo.find({
                where: {
                    ...
                    updatedAt: (0, typeorm_1.LessThan)(threeDayAgoMoment.toDate())
                },
            ...
            for (const order of paidOrdersToClose) {
                ...
                yield OrderService.updateOrderStatus(order, Statuses_1.default.CONFIRMED_BY_SYSTEM, buyerUser);
            }
            return true;
        });
    }
}
exports.default = ClosePaidOrderCron;
//# sourceMappingURL=ClosePaidOrderCron.js.map